...
- **HUB (личные планы):** /mnt/d/IWE/DS-strategy/current/
- **Документы стратегии:** /mnt/d/IWE/DS-strategy/docs/ (ВСЕ файлы: Strategy.md, Dissatisfactions.md, Session Agenda.md)
- **Inbox:** /mnt/d/IWE/DS-strategy/inbox/ ([fleeting-notes.md](https://github.com/upichugin/DS-strategy/blob/main/inbox/fleeting-notes.md) + свежие файлы за неделю)
- **SPOKE (планы репо):** /mnt/d/IWE/*/WORKPLAN.md
- **Стратегические карты:** /mnt/d/IWE/*/MAPSTRATEGIC.md (если есть в репо)
...
- Прочитай `/mnt/d/IWE/*/MAPSTRATEGIC.md` (если файл есть в репо)
...
- Прочитай `/mnt/d/IWE/*/WORKPLAN.md` из каждого репо
