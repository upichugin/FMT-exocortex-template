...
notify_telegram() {
    local scenario="$1"
    "/mnt/d/IWE/FMT-exocortex-template/roles/synchronizer/scripts/notify.sh" strategist "$scenario" >> "$LOG_FILE" 2>&1 || true
}
...
case "$1" in
    ...
    "week-review")
        ...
        KI_REPO="/mnt/d/IWE/DS-Knowledge-Index-upichugin"
